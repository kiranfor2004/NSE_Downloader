"""
Complete February Data - Load Feb 28th
"""
import pyodbc
import zipfile
import pandas as pd
...
# Load the missing February 28th file
zip_file = 'fo_udiff_downloads/BhavCopy_NSE_FO_0_0_0_20250228_F_0000.csv.zip'
if os.path.exists(zip_file):
    print(f'Loading February 28th: {zip_file}')
    ...
    with zipfile.ZipFile(zip_file, 'r') as zip_ref:
        ...
        if csv_files:
            ...
            # Clear any existing Feb 28th data
            cursor.execute("DELETE FROM step04_fo_udiff_daily WHERE trade_date = '20250228'")
            ...
            conn.commit()
            print(f'✅ Loaded {len(records):,} records for February 28th')
        else:
...
conn.close()
print("✅ February completion attempted!")